    ...
    <td valign="top"><table width="778" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="778" border="0" cellpadding="0" cellspacing="0" class="table_bottom2">
          <tr>
           <td width="123" class="t_left">工程项目</td>
...
%> 
            <td align="left" valign="top" height="230"><table width="50%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <a href="project_info.asp?id=<% =rs("id") %>"><img src="<% =IMGPath %>" width="330" height="180" title="<% =trim(rs("title")) %> "/></a></td>
              </tr>
              <tr>
                <td height="35" align="left"><a href="project_info.asp?id=<% =rs("id") %>">项目名字：<% =trim(rs("title")) %></a></td>
              </tr>
              </table></td>
<%
j=j+1
...
<% if i>0 then showpage("project.asp?classid="&classid&"&") %>
<%
rs.close
set rs=nothing
%> 
