...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:13px;">
  <tr>
    <td width="210" valign="top"><!--#include file="news_left.asp"--></td>
    <td width="15"></td>
    <td valign="top">
<%
NewsId=request.QueryString("NewsId")
set rs22=conn.execute("select title,content,addtime,classid,newspic from news where id="&NewsId&"")
    ...
    <table width="778" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="778" border="0" cellpadding="0" cellspacing="0"  class="table_bottom2">
          <tr>
           <td width="123" class="t_left">新闻中心</td>
            <td align="right" class="t_right">您所在的位置：首页  &gt; 新闻中心  &gt; <% =trim(RsC22("classname")) %> </td>
          </tr>
        </table></td>
      </tr>
      <tr>
