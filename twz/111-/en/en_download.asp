    ...
    <td valign="top"><table width="773" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="773" border="0" cellpadding="0" cellspacing="0" class="table_bottom2">
          <tr>
           <td width="123" class="t_left"><span class="t_right">SERVICE</span></td>
            <td align="right" class="t_right">LOCATION：HOME > SERVICE </td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
%>      
  ...
  <% if i>0 then enshowpage("en_download.asp?classid="&classid&"&") %>
  <%
rs.close
set rs=nothing
%> 
