...
%>
      <tr class="xian">
        ...
        <td width="83%" height="38"> <a class=" one_type" href="PRO.asp?classid=<% =rs("classpid") %>" title="<% =trim(rs("classname")) %>"><% =trim(rs("classname")) %></a> </td>
      </tr>
      <%
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="xian">
            ...
            <td width="94%" height="35"><a href="pro_info.asp?proid=<% =rs22("id") %>&classid=<% =classid %>" class="two_type" title="<% =trim(rs22("ProName")) %>"><% =trim(rs22("ProName")) %></a></td>
          </tr>
