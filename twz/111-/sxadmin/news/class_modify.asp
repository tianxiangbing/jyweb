...
<%  
  ...
  <table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
    <form id="form1" name="form1" method="post" action="../../sxadmin/news/class_modify.asp?action=edit&id=<%= id %>" onsubmit="return chkAddClass()">
	<tr>
	...
	<tr>
      ...
      <td><input name="EnClassName" type="text" id="EnClassName" value="<%= rs("EnClassName") %>" /></td>
    </tr>
    <tr>
      <td align="right" class="left_title_2">排　　序：</td>
      <td><input name="power" type="text" id="power" size="8" maxlength="8" value="<%= rs("power") %>" /> 
      <span class="red">*须为整数(默认值为0，按降序排列，即数字越大越在前面)</span></td>
    </tr>
    <tr>
      <td></td>
