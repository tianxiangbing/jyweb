...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:13px;">
  <tr>
    <td width="210" valign="top"><!--#include file="left.asp"--></td>
    <td width="15"></td>
    <td valign="top">
<%
...
%>
        ...
        <td><table width="778" border="0" cellpadding="0" cellspacing="0" class="table_bottom2">
          <tr>
           <td width="123" class="t_left">产品中心</td>
            <td align="right" class="t_right">您所在的位置：首页  &gt; 产品中心  &gt; <% =RsC("classname") %></td>
          </tr>
        </table></td>
      </tr>
      <tr>
    ...
    <div style="text-align:center;font-weight:bold; font-size:14px; padding:5px 0 5px 0px; "><% =RsC("classname") %></div>
    ...
    <div style="line-height:180%;"><div class="Section0" style="layout-grid:  15.6pt none">产品介绍： <% =trim(rs22("content")) %></div>
</div>
