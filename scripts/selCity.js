...
function initProvince() {
    ...
    document.getElementById("selProvince").options.add(new Option("-省份-", ""));
    for (i = 0; i < provinceArray.length; i++) {
        document.getElementById("selProvince").options[i + 1] = new Option(provinceArray[i], provinceArray[i]);
    }
}
...
function getCity(currProvince) {
    ...
    if (document.getElementById("selCity").options.length == 0) {
        document.getElementById("selCity").options.add(new Option("-城市-", ""));
    }
}