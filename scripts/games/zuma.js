...
*/
	...
	JY.extend(WordGame.prototype,{
		init : function(){
			...
			this.startTimer();
			/**创建欢迎界面**/
			this.titleScreen=JY.convertDOM('<div style="color:red;font-weight:bold;padding:200px 100px;width:300px;margin:0 auto;"><h1 style="color:red;font-weight:bold;">地下一百层-是男人就下到一百层</h1></div>');
			this.InstructionsScreen=JY.convertDOM('<div style="color:blue;padding:200px;width:300px;margin:0 auto;"><h1 style="color:red;font-weight:bold;">地下一百层-是男人就下到一百层</h1><p>点击开始游戏</p><p>选中相邻的两个交换位置,当达到横向或竖向的三个相同家庭成员时得分,消掉得分图片重新生成.倒计时结束时,游戏也就结束了.<a href="http://www.lovewebgames.com" target="_blank" style="color:blue;">作者：田想兵55342775@qq.com</a></p></div>');
			...
			var _self = this;
		    JY.loadFile("images/zuma/user1.jpg,images/zuma/user2.jpg,images/zuma/user3.jpg,images/zuma/user4.jpg","image",function(){
