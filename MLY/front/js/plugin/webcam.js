...
window.webcam = {
	...
	swf_url: $("#hd_camUrl").val() ||"webcam.swf", // URI to webcam.swf movie (defaults to cwd)
	...
	get_html: function(width, height, server_width, server_height) {
		...
		if (this.ie) {
			...
			html += '<embed id="webcam_movie" src="'+this.swf_url+'" loop="false" wmode="opaque" menu="false" quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" />';
		}
